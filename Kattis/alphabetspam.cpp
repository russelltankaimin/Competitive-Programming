...
void solve() {
  ...
  cout << setprecision(8) << wp / t.length() << endl;
  cout << setprecision(8) << l / t.length() << endl;
  cout << setprecision(8) << u / t.length() << endl;
  cout << setprecision(8) << s / t.length() << endl;
}
